    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
        <thead>
            <tr style="background: #f9fafb;">
                ...
                <th style="text-align: left; padding: 12px; border: 1px solid #e5e7eb;">State</th>
                <th style="text-align: left; padding: 12px; border: 1px solid #e5e7eb;">Join Date</th>
                ...
                <th style="text-align: left; padding: 12px; border: 1px solid #e5e7eb;">Title</th>
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 12px; border: 1px solid #e5e7eb;">
                        <span style="
                            display: inline-block;
                            background:
                                {{ $member->status === 'active' ? '#dcfce7' : ($member->status === 'inactive' ? '#f3f4f6' : '#fee2e2') }};
                            color:
                                {{ $member->status === 'active' ? '#166534' : ($member->status === 'inactive' ? '#374151' : '#991b1b') }};
                            padding: 4px 10px;
                            border-radius: 9999px;
                            font-size: 12px;
                            font-weight: 600;
            ...
            @empty
                <tr>
                    <td colspan="10" style="padding: 16px; text-align: center; border: 1px solid #e5e7eb; color: #6b7280;">
                        No members found.
                    </td>
                </tr>
            @endforelse
