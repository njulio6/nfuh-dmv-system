...
<div class="flex flex-col gap-6 animate-fadeIn">
    ...
    <x-premium-header 
        ...
        subtitle="Create a new traditional rank/title config in the system."
    ...
    <form method="POST" action="{{ route('titles.store') }}" class="w-full max-w-2xl flex flex-col gap-6">
        @csrf
